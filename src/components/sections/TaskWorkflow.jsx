      ...
      <div className="section-content">
        ...
        <CollapsibleCard title="Step 1: Logging Into External Platform">
          ...
          <ol className="step-list">
            <li>
              Log in using your <strong>alias email</strong> at: <a href="https://feedback.anthropic.com/surveyor/prwriter_transcript_review_snorkel_feb?email_login=true" 
                 target="_blank" 
                 rel="noopener noreferrer"
                 className="link">
                https://feedback.anthropic.com/surveyor/prwriter_transcript_review_snorkel_feb?email_login=true
              </a>
              <br />
